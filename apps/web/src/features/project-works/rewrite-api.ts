...
export type RewriteCheck = { code: string; status: "passed" | "blocked"; message: string; repairAction?: string; repairTarget?: { providerId?: string; connectionId?: string; workflowConfigurationId?: string; projectId?: string; stage?: string } | null };
