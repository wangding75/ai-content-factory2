...
const form:WorkflowForm={name:"w",connectionId:"id",applicableStages:["review"],referenceType:"workflow_id",referenceValue:"chapter-plan",inputContractVersion:"v1",outputContractVersion:"v1",defaultParametersJson:"{}",note:"",llmStrategy:"none",llmProviderId:"",llmModel:""};
