...
const futureItems = ["Review", "Works", "Settings"];

export function ProjectWorkspaceNav({ projectId, active }: { projectId: string; active: "overview" | "planning" | "materials" | "storylines" | "chapter-plans" }) {
