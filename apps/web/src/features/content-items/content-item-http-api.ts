...
export interface ContentGenerationCheck { code: string; status: "passed" | "warning" | "blocked"; message: string; repairAction?: string; repairTarget?: { providerId?: string; connectionId?: string; workflowConfigurationId?: string; projectId?: string; stage?: string } | null; }
