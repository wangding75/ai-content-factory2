...
$workflowName = 'ACF Iteration 17 Local Review'
$workflowId = 'f4e32de0-17a0-4100-8000-000000000001'
$webhookPath = 'acf-iteration-17-local-review'
$workflowPath = [System.IO.Path]::GetFullPath((Join-Path $PSScriptRoot '..\infra\n8n\workflows\iteration-17-local-review.json'))
$containerPath = '/tmp/iteration-17-local-review.json'
